window.addEventListener('DOMContentLoaded', () => {
  // html 문서에 모달 불러오기
  fetch('/team04-RB_frontend/webapp/app/modal/modalCareAllowReject.html')
...
window.addEventListener('DOMContentLoaded', () => {
  // html 문서에 모달 불러오기
  fetch('/team04-RB_frontend/webapp/app/modal/modalCareAllowFinished.html')
    .then(response => response.text())
    .then(data => {
...
const link2 = "./../../app/admin/careRequest.html";
function linkHref() {
  location.href=link;
}
